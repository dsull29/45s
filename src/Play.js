...
import { getCardValue } from "./scripts";
            ...
            <div className="hand">
                <div>
                    {turn > 0 &&
                        <div>Napkin</div>}
                    {turn > 0 && !playCard1 &&
                        <Turn deckUrl={deckUrl} player={order[0]} position={1} sendPlayCard={setPlayCard1} trumpSuit={trumpSuit} />}
                    {turn > 1 && !playCard2 &&
                        <Turn deckUrl={deckUrl} player={order[1]} position={2} sendPlayCard={setPlayCard2} trumpSuit={trumpSuit} leadSuit={leadSuit}/>}
                    {turn > 2 && !playCard3 &&
                        <Turn deckUrl={deckUrl} player={order[2]} position={3} sendPlayCard={setPlayCard3} trumpSuit={trumpSuit} leadSuit={leadSuit} />}
                    {turn > 3 && !playCard4 &&
                        <PlayerTurn deckUrl={deckUrl} player={order[3]} position={4} sendPlayCard={setPlayCard4} trumpSuit={trumpSuit} leadSuit={leadSuit} />}
                </div>
